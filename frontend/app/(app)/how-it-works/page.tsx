...
const STEPS = [
    {
        title: "Walk up to a machine",
        body: "Any Conserve machine that's open. You don't pick a site in the app first.",
    },
    {
        title: "Get a code",
    ...
    {
        title: "Turn it in",
        body: "Put the plastic on the scale and press weigh. The machine counts the kilos. Your phone never enters a weight.",
    },
    {
        title: "Get paid",
        body: "Green Points land in your wallet. One point is ₦1. The site sets the price per kilo.",
    },
]
        ...
        <PageContainer width="narrow" className="space-y-8">
            <header>
                ...
                <p className="mt-2 text-muted-foreground">
                    You&apos;re standing at a machine. That&apos;s the whole setup.
                </p>
            </header>
